  ...
  const labels = talkingHeadsAlbums[6].albumDetails.labels;
  
   console.log(labels);
  
  // Exercise 9:  Using the talkingHeadsAlbums array, assign album7's released property to album6's released property
  
  // const labels = talkingHeadsAlbums[5].albumDetails.labels;
   //console.log(album3.albumDetails.released.toLocaleDateString());
  
   talkingHeadsAlbums[5].albumDetails.released = new Date(album7.albumDetails.released);
  
  
  console.log(talkingHeadsAlbums[5].albumDetails.released.toLocaleDateString());
